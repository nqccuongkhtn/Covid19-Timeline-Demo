const countries = new Map([//Map kiểu dữ liệu map gồm cặp key và value
...
const getCountry = (name) => ([...countries].find(([_, c]) => c.name === name) || [])[1];//find dựa vào new MAp ... là Spread Operator
export {getCountry};